...
from onepostly.configuration import Configuration
from onepostly.api_response import ApiResponse, T as ApiResponseT
import onepostly.models
from onepostly import rest
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/0.2.10/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(onepostly.models, klass)
