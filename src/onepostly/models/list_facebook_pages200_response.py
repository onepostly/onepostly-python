...
class ListFacebookPages200Response(BaseModel):
    ...
    """ # noqa: E501
    pages: List[ListFacebookPages200ResponsePagesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pages": [ListFacebookPages200ResponsePagesInner.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None
        })
        return _obj
