...
class ListRetweeters200ResponseRetweets(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListRetweeters200ResponseRetweets from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListRetweeters200ResponseRetweets from a dict"""
        if obj is None:
            return None
