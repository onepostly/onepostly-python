...
class SelectInstagramAccountRequest(BaseModel):
    ...
    instagram_account_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="instagramAccountId")
    redirect_url: Optional[StrictStr] = Field(default=None, alias="redirectUrl")
    __properties: ClassVar[List[str]] = ["tempToken", "instagramAccountId", "redirectUrl"]
