...
class LikeComment200ResponseLiked(BaseModel):
    """
    ...
    liked: StrictBool
    __properties: ClassVar[List[str]] = ["postId", "destinationId", "platform", "commentId", "liked"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LikeComment200ResponseLiked from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LikeComment200ResponseLiked from a dict"""
        if obj is None:
            return None
