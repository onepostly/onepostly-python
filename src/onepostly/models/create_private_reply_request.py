...
class CreatePrivateReplyRequest(BaseModel):
    """
    ...
    comment_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Platform-native comment id.", alias="commentId")
    text: Annotated[str, Field(min_length=1, strict=True, max_length=2000)]
    __properties: ClassVar[List[str]] = ["post", "accountId", "destinationId", "commentId", "text"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatePrivateReplyRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatePrivateReplyRequest from a dict"""
        if obj is None:
            return None
