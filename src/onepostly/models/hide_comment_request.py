...
class HideCommentRequest(BaseModel):
    ...
    hidden: StrictBool
    __properties: ClassVar[List[str]] = ["post", "accountId", "destinationId", "commentId", "hidden"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HideCommentRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HideCommentRequest from a dict"""
        if obj is None:
            return None
