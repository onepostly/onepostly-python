...
class CreatePostBody(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatePostBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatePostBody from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "destinations": [CreatePostBodyDestinationsInner.from_dict(_item) for _item in obj["destinations"]] if obj.get("destinations") is not None else None
        })
        return _obj
