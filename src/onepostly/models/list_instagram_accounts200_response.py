...
class ListInstagramAccounts200Response(BaseModel):
    """
    ListInstagramAccounts200Response
    """ # noqa: E501
    accounts: List[ListInstagramAccounts200ResponseAccountsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [ListInstagramAccounts200ResponseAccountsInner.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
