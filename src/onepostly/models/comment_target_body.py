...
class CommentTargetBody(BaseModel):
    """
    CommentTargetBody
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["post", "accountId", "destinationId", "commentId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommentTargetBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommentTargetBody from a dict"""
        if obj is None:
            return None
