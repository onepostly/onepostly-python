...
class HideComment200ResponseHidden(BaseModel):
    """
    ...
    hidden: StrictBool
    __properties: ClassVar[List[str]] = ["postId", "destinationId", "platform", "commentId", "hidden"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HideComment200ResponseHidden from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HideComment200ResponseHidden from a dict"""
        if obj is None:
            return None
