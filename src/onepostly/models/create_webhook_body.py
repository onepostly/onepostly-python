...
class CreateWebhookBody(BaseModel):
    ...
    events: Annotated[List[StrictStr], Field(min_length=1, max_length=22)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateWebhookBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateWebhookBody from a dict"""
        if obj is None:
            return None
